...
2. subcategory（string，仅 relevant=true 时填写，否则留空）：
   ...
   - gz-wealth：财富管理（理财/基金/保险/黄金/存款/利率），**仅限明确涉及广州/南沙/湛江/清远本地**（本地机构/本地客群/本地政策落地）
   - gz-credit：个人信贷（房贷/消费贷/经营贷/普惠），**仅限广州本地**（广州房贷/公积金/本地信贷动态）
   ...
   - news：国际宏观
   判断口诀：**涉及广州本地落地才归 gz-\*；全国性报道一律 cn-finance/news/cn-policy。**
